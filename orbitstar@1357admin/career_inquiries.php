...
if (isset($_POST['action']) && $_POST['action'] === 'delete') {
    ...
    if (!empty($ids) && is_array($ids)) {
        ...
        if (!empty($clean_ids)) {
            ...
            $deleteQuery = "DELETE FROM career_inquiries WHERE id IN ($placeholders)";
...
$allInquiries = [];
try {
    $allInquiries = $db->getAllData("SELECT * FROM career_inquiries ORDER BY id DESC");
} catch (Exception $e) {}
?>
<!DOCTYPE html>
...
<head>
    <meta charset="utf-8" />
    <title>Serene Designs | Career Inquiries</title>
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header"><h2 class="card-title">Career Inquiries</h2></div>
                        <div class="card-body">
                                ...
                                <table class="table align-middle" id="datatable">
                                    ...
                                    <?php if (!empty($allInquiries)): ?>
                                        ...
                                        <tr id="row-<?php echo $item['id']; ?>">
                                            ...
                                            <td>
                                                <?php if (!empty($item['cv_file'])): ?>
                                                    <a href="../images/cvs/<?php echo htmlspecialchars($item['cv_file']); ?>" target="_blank" class="badge bg-primary text-white">View CV</a>
                                                <?php else: ?>
