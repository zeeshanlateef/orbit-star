...
if (isset($_POST['action']) && $_POST['action'] === 'delete') {
    ...
    if (!empty($ids) && is_array($ids)) {
        ...
        if (!empty($clean_ids)) {
            ...
            $deleteQuery = "DELETE FROM quote WHERE id IN ($placeholders)";
...
$allInquiries = [];
try {
    $allInquiries = $db->getAllData("SELECT * FROM quote ORDER BY id DESC");
} catch (Exception $e) {}
?>
<!DOCTYPE html>
...
<head>
    <meta charset="utf-8" />
    <title>Orbit Star Services | Service Inquiries</title>
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header"><h2 class="card-title">Free Consultation Inquiries</h2></div>
                        <div class="card-body">
