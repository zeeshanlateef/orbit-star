...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Note: 'code' and 'services' are part of the db schema.
    // In Orbit Star, the Free Consultation form doesn't have them, so we assign default values.
    $code = isset($_POST["code"]) ? test_input($_POST["code"]) : "N/A";
    $services = isset($_POST["services"]) ? test_input($_POST["services"]) : "Free Consultation";
    ...
    // Send Email
    $to1 = 'admin@orbitstarservices.com';
    $email_subject = "Free Consultation Request: $name";
    ...
    <body>
        <div class='email-container'>
            <div class='header'>
                ...
                <p style='margin: 5px 0 0; opacity: 0.9; color: #d8aa53;'>Free Consultation Request</p>
            </div>
            <div class='content'>
                <p>Hello Team,</p>
                <p>You have received a new free consultation request. Here are the details:</p>
                ...
                <div class='message-box'>
                    ...
                    " . (!empty($message_content) ? nl2br($message_content) : "No message provided.") . "
                </div>
            </div>
            <div class='footer'>
                This request was sent from the consultation form on orbitstarservices.com<br>
    ...
    try {
        ...
        $db_success = $db->executeStatement(
            "INSERT INTO quote (name, email, phone, code, services, message) VALUES (:name, :email, :phone, :code, :services, :message)",
            [
                ':name' => $name,
                ':email' => $email,
                ':phone' => $phone,
